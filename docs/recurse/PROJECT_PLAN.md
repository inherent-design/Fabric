...
- **AM:**
  ...
  - [ ] Basic player controller (movement).
- **PM:**
  - [ ] Implement Function System (casting logic).
  - [ ] Implement `CREATE_MATTER` function + `TARGET_POINT` block.
...
- **PM:**
  ...
  - [ ] Build and script Level 1 (Combat).
...
- **PM:**
  - [ ] Sound effects and simple music.
  - [ ] VFX polish on transformations and function casting.
  - [ ] Bug fixing.
  - [ ] Build, package, and write submission page.
  - **GOAL: A complete, submittable 10-minute game.**
