...
function(_fabric_compile_particle_shader SHADER_FILE SHADER_TYPE OUT_VAR)
    ...
    foreach(_IDX RANGE 0 ${_LAST})
        ...
        set(_OUT_DIR "${FABRIC_PARTICLE_SHADER_OUT}/${_EXT}")
        ...
        add_custom_command(
            ...
            COMMAND bgfx::shaderc
                ...
                --varyingdef "${FABRIC_PARTICLE_SHADER_DIR}/varying.def.sc"
                --bin2c "${_NAME}_${_EXT}"
            MAIN_DEPENDENCY "${SHADER_FILE}"
            DEPENDS "${FABRIC_PARTICLE_SHADER_DIR}/varying.def.sc"
...
_fabric_compile_particle_shader("${FABRIC_PARTICLE_SHADER_DIR}/vs_particle.sc" vertex PARTICLE_VS_OUTPUTS)
_fabric_compile_particle_shader("${FABRIC_PARTICLE_SHADER_DIR}/fs_particle.sc" fragment PARTICLE_FS_OUTPUTS)
