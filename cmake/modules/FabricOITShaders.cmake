...
function(_fabric_compile_oit_shader SHADER_FILE SHADER_TYPE OUT_VAR)
    ...
    foreach(_IDX RANGE 0 ${_LAST})
        ...
        set(_OUT_DIR "${FABRIC_OIT_SHADER_OUT}/${_EXT}")
        ...
        add_custom_command(
            ...
            COMMAND bgfx::shaderc
                ...
                --varyingdef "${FABRIC_OIT_SHADER_DIR}/varying.def.sc"
                --bin2c "${_NAME}_${_EXT}"
            MAIN_DEPENDENCY "${SHADER_FILE}"
            DEPENDS "${FABRIC_OIT_SHADER_DIR}/varying.def.sc"
...
_fabric_compile_oit_shader("${FABRIC_OIT_SHADER_DIR}/vs_oit_accum.sc" vertex OIT_VS_ACCUM_OUTPUTS)
_fabric_compile_oit_shader("${FABRIC_OIT_SHADER_DIR}/fs_oit_accum.sc" fragment OIT_FS_ACCUM_OUTPUTS)
_fabric_compile_oit_shader("${FABRIC_OIT_SHADER_DIR}/vs_oit_composite.sc" vertex OIT_VS_COMPOSITE_OUTPUTS)
_fabric_compile_oit_shader("${FABRIC_OIT_SHADER_DIR}/fs_oit_composite.sc" fragment OIT_FS_COMPOSITE_OUTPUTS)
