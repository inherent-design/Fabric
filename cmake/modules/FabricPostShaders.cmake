...
function(_fabric_compile_post_shader SHADER_FILE SHADER_TYPE OUT_VAR)
    ...
    foreach(_IDX RANGE 0 ${_LAST})
        ...
        set(_OUT_DIR "${FABRIC_POST_SHADER_OUT}/${_EXT}")
        ...
        add_custom_command(
            ...
            COMMAND bgfx::shaderc
                ...
                --varyingdef "${FABRIC_POST_SHADER_DIR}/varying.def.sc"
                --bin2c "${_NAME}_${_EXT}"
            MAIN_DEPENDENCY "${SHADER_FILE}"
            DEPENDS "${FABRIC_POST_SHADER_DIR}/varying.def.sc"
...
_fabric_compile_post_shader("${FABRIC_POST_SHADER_DIR}/vs_fullscreen.sc" vertex POST_VS_OUTPUTS)
_fabric_compile_post_shader("${FABRIC_POST_SHADER_DIR}/fs_bright.sc" fragment POST_FS_BRIGHT_OUTPUTS)
_fabric_compile_post_shader("${FABRIC_POST_SHADER_DIR}/fs_blur.sc" fragment POST_FS_BLUR_OUTPUTS)
_fabric_compile_post_shader("${FABRIC_POST_SHADER_DIR}/fs_tonemap.sc" fragment POST_FS_TONEMAP_OUTPUTS)
