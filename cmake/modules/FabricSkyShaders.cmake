...
function(_fabric_compile_sky_shader SHADER_FILE SHADER_TYPE OUT_VAR)
    ...
    foreach(_IDX RANGE 0 ${_LAST})
        ...
        set(_OUT_DIR "${FABRIC_SKY_SHADER_OUT}/${_EXT}")
        ...
        add_custom_command(
            ...
            COMMAND bgfx::shaderc
                ...
                --varyingdef "${FABRIC_SKY_SHADER_DIR}/varying.def.sc"
                --bin2c "${_NAME}_${_EXT}"
            MAIN_DEPENDENCY "${SHADER_FILE}"
            DEPENDS "${FABRIC_SKY_SHADER_DIR}/varying.def.sc"
...
_fabric_compile_sky_shader("${FABRIC_SKY_SHADER_DIR}/vs_sky.sc" vertex SKY_VS_OUTPUTS)
_fabric_compile_sky_shader("${FABRIC_SKY_SHADER_DIR}/fs_sky.sc" fragment SKY_FS_OUTPUTS)
