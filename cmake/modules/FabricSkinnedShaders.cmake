...
function(_fabric_compile_skinned_shader SHADER_FILE SHADER_TYPE OUT_VAR)
    ...
    foreach(_IDX RANGE 0 ${_LAST})
        ...
        set(_OUT_DIR "${FABRIC_SKINNED_SHADER_OUT}/${_EXT}")
        ...
        add_custom_command(
            ...
            COMMAND bgfx::shaderc
                ...
                --varyingdef "${FABRIC_SKINNED_SHADER_DIR}/varying.def.sc"
                --bin2c "${_NAME}_${_EXT}"
            MAIN_DEPENDENCY "${SHADER_FILE}"
            DEPENDS "${FABRIC_SKINNED_SHADER_DIR}/varying.def.sc"
...
_fabric_compile_skinned_shader("${FABRIC_SKINNED_SHADER_DIR}/vs_skinned.sc" vertex SKINNED_VS_OUTPUTS)
_fabric_compile_skinned_shader("${FABRIC_SKINNED_SHADER_DIR}/fs_skinned.sc" fragment SKINNED_FS_OUTPUTS)
