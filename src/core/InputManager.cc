...
float InputManager::mouseX() const { return mouseX_; }
float InputManager::mouseY() const { return mouseY_; }
float InputManager::mouseDeltaX() const { return mouseDeltaX_; }
float InputManager::mouseDeltaY() const { return mouseDeltaY_; }
