...
TextureLayoutRectangle::TextureLayoutRectangle(const uint64_t _id, const Rml::Vector2i dimensions)
...
Rml::Vector2i TextureLayoutRectangle::GetPosition() const {
    return texture_position;
}

Rml::Vector2i TextureLayoutRectangle::GetDimensions() const {
    return dimensions;
}

void TextureLayoutRectangle::Place(const int _texture_index, const Rml::Vector2i position) {
...
void TextureLayoutRectangle::Allocate(Rml::byte* _texture_data, int _texture_stride) {
...
Rml::byte* TextureLayoutRectangle::GetTextureData() {
    return texture_data;
}
