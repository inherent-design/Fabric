...
private:
  ...
  BufferSlot(BufferPool* pool, uint8_t* data, size_t size)
...
class BufferPool {
public:
  BufferPool(size_t slotSize, size_t slotCount)
      : slotSize_(slotSize), slotCount_(slotCount) {
...
inline BufferSlot::~BufferSlot() { release(); }
