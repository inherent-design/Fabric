...
template <typename T> class Result {
  public:
    ...
    static Result error(ErrorCode code, std::string message = "") { return Result(code, std::move(message)); }
  ...
  private:
    explicit Result(T value) : code_(ErrorCode::Ok), value_(std::move(value)) {}
