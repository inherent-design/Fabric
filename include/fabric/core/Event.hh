...
class Event {
  public:
    ...
    template <typename T> void setData(const std::string& key, const T& value);
...
class EventDispatcher {
  public:
    ...
    std::string addEventListener(const std::string& eventType, const EventHandler& handler, int32_t priority = 0);
